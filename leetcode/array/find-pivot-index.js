...
var pivotIndex = function (nums) {
  ...
  for (let i = 0; i < nums.length; i++) {
    let rTotal = total - lTotal - nums[i];
    console.log(lTotal, rTotal);
    if (lTotal === rTotal) {
      return i;
    }
...
// console.log(pivotIndex([0, 0, 0, 1, 7, 4, 9, 5, 7]));
// console.log(pivotIndex([1, 7, 4, 9, 9, 9, 9, 9, 9, 5, 7]));
// console.log(pivotIndex([1, 7, 3, 5, 6]));
