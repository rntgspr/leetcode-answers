...
const given0 = JSON.parse("[[10,16],[2,8],[1,6],[7,12]]");
const given1 = JSON.parse("[[1,2],[3,4],[5,6],[7,8]]");
const given2 = JSON.parse("[[1,2],[2,3],[3,4],[4,5]]");

console.log(findMinArrowShots(given0));
console.log(findMinArrowShots(given1));
console.log(findMinArrowShots(given2));
